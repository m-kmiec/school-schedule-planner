...
const AddEmployee = (props: Props) => {
    ...
    const onSubmitButtonClick = (e: FormEvent) => {
        e.preventDefault();
        const data: Course = {
            subject: {name: subject,abbre: subject.substring(0,4), isMandatory: false},
    ...
    return (
        <div className="form-container">
            ...
            <form onSubmit={onSubmitButtonClick}>
                <div>
                    <label>Subject: </label>
                    <input type="text" required value = {subject} onChange={onSubjectChanged}/>
                </div>
                <div>
                    <label>Teacher: </label>
                    <input type="text" required value = {teacher} onChange={onTeacherChanged}/>
                </div>
                <div>
                    <label>Type: </label>
                ...
                <div>
                    ...
                    <input type="number" required value = {duration} onChange={onDurationChanged}/>
                </div>
                <div>
                    <label>Hours required: </label>
                    <input type="number" required value = {hoursReq} onChange={onHoursReqChanged}/>
                </div>
                <div>
