...
const EditGroups = (props: Props) => {
    ...
    const handleChangeOfGroups = (event: React.ChangeEvent<HTMLSelectElement>) =>{
    ...
    return (
        <div className="form-container">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className = "editGroupForm">
            <div className = "form-group">
                ...
                <div className = "form-group">
                    ...
                    <select onChange={handleChangeOfGroups} name='additionalCourses' multiple>
                        {courses.map(c => (
